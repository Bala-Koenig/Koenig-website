  ...
  return (
    ...
    <style suppressHydrationWarning>{`
      @media(max-width:700px){
        .curr-pills-grid { grid-template-columns: repeat(2,1fr) !important; }
        .curr-accordion-btn { padding-left: 16px !important; padding-right: 16px !important; padding-top: 14px !important; padding-bottom: 14px !important; gap: 12px !important; }
        .curr-accordion-body { padding-left: 16px !important; padding-right: 16px !important; padding-bottom: 16px !important; }
      }
      @media(max-width:375px){
        .curr-pills-grid { grid-template-columns: 1fr !important; }
        .curr-accordion-btn { padding-left: 12px !important; padding-right: 12px !important; padding-top: 12px !important; padding-bottom: 12px !important; gap: 10px !important; }
      }
    `}</style>
    <section id="curriculum" ref={sectionRef} className="py-24 bg-white overflow-hidden" aria-labelledby="curriculum-heading">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="animate-on-scroll text-center max-w-3xl mx-auto mb-12">
          <span className="section-badge mb-5 inline-flex"><svg viewBox="0 0 24 24" fill="none" width="14" height="14" style={{display:'inline',verticalAlign:'middle'}}><path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2" stroke="#0694D1" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/><rect x="9" y="3" width="6" height="4" rx="1" stroke="#0694D1" strokeWidth="1.8"/><path d="M9 14l2 2 4-4" stroke="#0694D1" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg> Curriculum</span>
          <h2 id="curriculum-heading" className="font-heading font-bold leading-tight mb-5" style={{ color: C.dark, fontSize: "clamp(22px, 3.5vw, 36px)", fontWeight: 700, letterSpacing: "-0.015em", lineHeight: 1.4 }}>
            Comprehensive{" "}
        ...
        {/* Summary pills */}
        <div className="curr-pills-grid animate-on-scroll grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="curr-accordion-btn w-full flex items-center gap-4 px-6 py-5 text-left group"
                ...
                <div className="accordion-content" style={{ maxHeight: isOpen ? "600px" : "0" }}>
                  <div className="curr-accordion-body px-6 pb-6">
