...
export default function LiveOnlineClassroomPage() {
  ...
  return (
    <div style={{ fontFamily: "'GT Walsheim Pro', sans-serif" }}>
      ...
      {/* ── HERO ─────────────────────────────────────────────── */}
      <section className="relative overflow-hidden px-4 lg:px-[50px]" style={{ background: 'linear-gradient(135deg, #061624 0%, #071929 60%, #062236 100%)', paddingTop: 35, paddingBottom: 35 }}>
