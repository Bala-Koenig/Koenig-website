      ...
      <div className="px-4 pt-4 pb-3" style={{ borderBottom: '1px solid #F1F5F9' }}>
        ...
        <div className="flex items-center gap-3 mt-2.5">
          <button onClick={onSyllabus}
            className="flex items-center gap-1 rounded-full px-2.5 py-0.5 text-[10px] font-semibold transition-all hover:bg-[#EBF8FE]"
          ...
          <div className="flex items-center gap-1 text-[10px] font-semibold" style={{ color: '#475569' }}>
