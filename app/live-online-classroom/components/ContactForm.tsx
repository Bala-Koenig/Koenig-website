...
const hearAboutOptions = [
  ...
  "Email Newsletter", "Conference / Event", "Word of Mouth", "Other",
];
...
export default function ContactForm({ initialType = "individual" }: { initialType?: "individual" | "enterprise" }) {
  const [type,    setType]    = useState<"individual" | "enterprise">(initialType);
