...
const TESTIMONIALS = [
  { name: 'Adham Al Mayasi',   role: 'IT Professional, 🇴🇲 Oman',      course: 'AZ-104: Microsoft Azure Administrator',         initials: 'AA', bg: 'linear-gradient(135deg,#076D9D,#4DBFEF)', quote: 'Having the trainer fly to our office in Muscat was a game changer. Our entire team trained together on our own systems — no travel, no disruption. The onsite delivery was seamless and far more effective than anything we had tried before.' },
  { name: 'Emmanuel Masabo',   role: 'Network Engineer, 🇷🇼 Rwanda',    course: 'CCNA (200-301): Cisco Certified Network Associate', initials: 'EM', bg: 'linear-gradient(135deg,#093148,#076D9D)', quote: 'The trainer is very organised and helped us understand difficult concepts in simple ways. Training at our premises in Kigali meant we could use our actual network equipment — that hands-on relevance made all the difference.' },
  { name: 'Yoosuf Nizam',     role: 'Cloud Architect, 🇲🇻 Maldives',   course: 'AWS Solutions Architect – Associate (SAA-C03)',    initials: 'YN', bg: 'linear-gradient(135deg,#F47920,#f6a05c)', quote: 'This trainer is undoubtedly one of the finest I have encountered. His profound knowledge and articulate teaching style make complex concepts accessible. The FMAT format allowed us to train our whole cloud team without anyone leaving the island.' },
  { name: 'Amjad Kushar',     role: 'IT Manager, 🇸🇦 Saudi Arabia',    course: 'AZ-500: Microsoft Azure Security Technologies',   initials: 'AK', bg: 'linear-gradient(135deg,#093148,#F47920)', quote: 'We needed training on sensitive internal systems and could not risk sending data outside. FMAT was the perfect solution — the trainer came to us, the curriculum was tailored to our environment, and the all-inclusive pricing had no surprises.' },
  { name: 'David Muriuki',    role: 'Security Engineer, 🇰🇪 Kenya',    course: 'CEH v13: Certified Ethical Hacker',               initials: 'DM', bg: 'linear-gradient(135deg,#34A853,#076D9D)', quote: 'Koenig arranged everything — trainer flights, accommodation, schedule — within days. The instructor arrived at our Nairobi office fully prepared. His real-world approach to ethical hacking, delivered in our own environment, was outstanding.' },
  { name: 'Monica Kalamula',  role: 'Systems Admin, 🇲🇼 Malawi',       course: 'CompTIA Security+ (SY0-701)',                      initials: 'MK', bg: 'linear-gradient(135deg,#476D8D,#0694D1)', quote: 'I was sceptical about onsite training but the experience exceeded every expectation. The trainer flew in, adapted the syllabus to our infrastructure, and our entire IT team completed Security+ together. One of the best training investments we have made.' },
]
        ...
        <div className="relative mx-auto max-w-7xl px-4 md:px-8 lg:px-[50px]" style={{ paddingTop: 35, paddingBottom: 35 }}>
          <div className="grid lg:grid-cols-2 gap-0 lg:gap-16 items-center">
            ...
            <div>
              ...
              {/* Carbon pledge */}
              <div className="mb-[15px] inline-flex items-center gap-2.5 rounded-xl px-4 py-2.5"
