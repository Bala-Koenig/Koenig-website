            ...
            <button key={i} onClick={() => setSelectedSlot(i)}
              ...
              <div className="flex items-start justify-between gap-2">
                <div className="flex flex-col gap-1">
                  ...
                  {active && (
                    <span className="flex items-center gap-1.5 text-[11px]" style={{ color: '#0694D1' }}>
  ...
  return (
    <>
      <div className="flex gap-3 mb-5">
        <button className="flex-1 flex items-center justify-center gap-2 rounded-xl py-2.5 text-sm font-semibold transition hover:bg-white/10" style={{ border: '1px solid rgba(255,255,255,0.18)', color: 'white', background: 'rgba(255,255,255,0.06)' }}>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="hidden lg:block">
              <div className="relative mx-auto" style={{ width: '500px', padding: '44px' }}>
                {([
                  { val: '50+',    label: 'Cities',     pos: { top: 0,    left: 0   }, anim: 'lolFloat1 3.4s ease-in-out infinite' },
                ...
                <div className="relative overflow-hidden rounded-2xl"
                  ...
                  <img src="/images/home-banner/Classroom-Training.png" alt="Classroom Training" className="w-full h-auto object-contain" />
                </div>
              </div>
            </div>
