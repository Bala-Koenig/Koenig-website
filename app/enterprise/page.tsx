...
const TESTIMONIALS_COL3 = [
  { quote: '"AI-102 was daunting but the trainer broke it down perfectly. Real Azure OpenAI labs made the difference. Highly recommend."', extra: 'The hands-on Azure OpenAI Service labs were unlike anything I found in self-paced courses. We built real prompt-engineering workflows and tested GPT-4 deployments. The trainer had actual project experience with enterprise AI — it showed in every session.', highlights: ['Azure OpenAI Labs', 'Expert MCT'], name: 'David L.', country: 'United States', badge: 'AI-102 Certified', date: '2 weeks ago', img: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=80&h=80&fit=crop&crop=faces&auto=format&q=80' },
