  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-white" style={{ fontFamily: "'GT Walsheim Pro', sans-serif" }}>
      ...
      <header
        ...
        style={{ background: '#061624', borderBottom: '1px solid rgba(255,255,255,0.08)' }}
      ...
      >
        <div className="mx-auto flex max-w-7xl items-center gap-6 py-2 lg:py-3">
          ...
          <nav className="hidden items-center gap-4 lg:flex">
            ...
            <a href="#" className="flex items-center gap-1 px-1 py-2 text-sm font-medium transition-colors" style={{ color: 'rgba(255,255,255,0.80)' }} onMouseEnter={e => (e.currentTarget.style.color = '#38bdf8')} onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.80)')}>Technologies<svg className="h-3 w-3 opacity-50 ml-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7"/></svg></a>
            <a href="#" className="flex items-center gap-1 px-1 py-2 text-sm font-medium transition-colors" style={{ color: 'rgba(255,255,255,0.80)' }} onMouseEnter={e => (e.currentTarget.style.color = '#38bdf8')} onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.80)')}>Vendors<svg className="h-3 w-3 opacity-50 ml-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7"/></svg></a>
            <a href="#" className="flex items-center gap-1 px-1 py-2 text-sm font-medium transition-colors" style={{ color: 'rgba(255,255,255,0.80)' }} onMouseEnter={e => (e.currentTarget.style.color = '#38bdf8')} onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.80)')}>About<svg className="h-3 w-3 opacity-50 ml-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7"/></svg></a>
            <a href="#" className="flex items-center gap-1 px-1 py-2 text-sm font-medium transition-colors" style={{ color: 'rgba(255,255,255,0.80)' }} onMouseEnter={e => (e.currentTarget.style.color = '#38bdf8')} onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.80)')}>Contact<svg className="h-3 w-3 opacity-50 ml-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7"/></svg></a>
          </nav>
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="relative hidden lg:block" ref={navSearchRef}>
              <div className="flex items-center gap-2 rounded-lg border border-white/20 px-3 py-1.5 transition-all focus-within:border-[#0694D1]" style={{ background: 'rgba(255,255,255,0.07)' }}>
                <svg aria-hidden="true" className="h-3.5 w-3.5 shrink-0 text-white/50" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                <input
                  type="text"
                  value={navQuery}
                  ...
                  className="w-36 bg-transparent text-sm text-white/80 placeholder-white/40 outline-none"
                />
              </div>
