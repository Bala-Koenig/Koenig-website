      ...
      >
        <div className="mx-auto flex max-w-7xl items-center gap-6 py-2 lg:py-3">
          ...
          <Link href="/" className="flex shrink-0 items-center gap-2">
            <div style={{ background: 'rgba(255,255,255,0.18)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', border: '1px solid rgba(255,255,255,0.4)', borderRadius: '10px', padding: '6px 12px', boxShadow: '0 4px 24px rgba(255,255,255,0.08), inset 0 1px 0 rgba(255,255,255,0.3)' }}>
