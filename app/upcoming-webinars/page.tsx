        ...
        <div className="mx-auto max-w-7xl">
          <div className="rounded-2xl px-6 py-6" style={{ background: '#EBF8FE' }}>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 divide-y sm:divide-y-0 divide-x-0 sm:divide-x divide-[#CAEFFF]">
              {[
                { value: '33+',   label: 'Years Training Excellence',
                ...
                { value: '5000+', label: 'Courses Offered',
                  icon: <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.966 8.966 0 00-6 2.292m0-14.25v14.25"/> },
                { value: '30K+',  label: 'Monthly Students',
