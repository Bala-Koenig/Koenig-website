...
const COURSES = [
  {
    ...
    tags: ['POPULAR', 'ASSOCIATE'], rating: 4.9, enrolled: '2,100+', price: 'INR 9999', certFee: 4999,
  ...
  },
  {
    ...
    duration: 40, accessDuration: '90 Days',
    tags: ['EXPERT'], rating: 4.8, enrolled: '1,100+', price: 'INR 9999', certFee: 4999,
    techs: ['Microsoft Azure'],
    startImmediately: true,
  },
  {
    ...
    duration: 32, accessDuration: '90 Days',
    tags: ['EXPERT'], rating: 4.8, enrolled: '1,150+', price: 'INR 9999', certFee: 4999,
    techs: ['Microsoft Azure'],
    startImmediately: true,
  },
  {
    ...
    tags: ['POPULAR', 'EXPERT'], rating: 4.9, enrolled: '2,600+', price: 'INR 9999', certFee: 4999,
  ...
  },
  {
    ...
    tags: ['POPULAR', 'ASSOCIATE'], rating: 4.9, enrolled: '1,800+', price: 'INR 9999', certFee: 4999,
  ...
  },
  {
    ...
    tags: ['POPULAR', 'ASSOCIATE'], rating: 4.9, enrolled: '1,900+', price: 'INR 9999', certFee: 4999,
    techs: ['AWS Cloud'],
    startImmediately: true,
  },
  {
  ...
  },
  {
    ...
    duration: 40, accessDuration: '180 Days',
    tags: ['POPULAR', 'EXPERT'], rating: 4.9, enrolled: '2,200+', price: 'INR 9999', certFee: 4999,
  ...
  },
  {
    ...
    duration: 40, accessDuration: '90 Days',
    tags: ['POPULAR', 'ASSOCIATE'], rating: 4.8, enrolled: '3,100+', price: 'INR 9999', certFee: 4999,
    techs: ['Cyber Security'],
    startImmediately: true,
  },
  {
    ...
    duration: 40, accessDuration: '180 Days',
    tags: ['POPULAR', 'ASSOCIATE'], rating: 4.8, enrolled: '2,400+', price: 'INR 9999', certFee: 4999,
    techs: ['CCNA'],
    startImmediately: false,
  },
  {
  ...
  },
  {
    ...
    duration: 8, accessDuration: '60 Days',
    tags: ['POPULAR', 'FUNDAMENTALS'], rating: 4.8, enrolled: '4,100+', price: 'INR 9999', certFee: 4999,
    techs: ['Microsoft Azure'],
    startImmediately: true,
  },
  {
  ...
  },
  {
    ...
    duration: 40, accessDuration: '180 Days',
    tags: ['EXPERT'], rating: 4.9, enrolled: '1,650+', price: 'INR 9999', certFee: 4999,
    techs: ['AWS Cloud'],
    startImmediately: false,
  },
  {
    ...
    duration: 40, accessDuration: '90 Days',
    tags: ['ASSOCIATE'], rating: 4.7, enrolled: '1,850+', price: 'INR 9999', certFee: 4999,
    techs: ['Networking'],
    startImmediately: true,
  },
  {
  ...
  },
  {
    ...
    duration: 32, accessDuration: '90 Days',
    tags: ['ASSOCIATE'], rating: 4.8, enrolled: '680+', price: 'INR 9999', certFee: 4999,
    techs: ['Oracle Cloud'],
    startImmediately: true,
  },
  {
  ...
  },
  {
    ...
    duration: 40, accessDuration: '180 Days',
    tags: ['EXPERT'], rating: 4.9, enrolled: '630+', price: 'INR 9999', certFee: 4999,
    techs: ['Ethical Hacking and Penetration Testing', 'Cyber Security'],
    startImmediately: false,
  },
  {
...
const TESTIMONIALS = [
  { name: 'Norman Lardizabal', role: 'IT Professional, Philippines', course: 'AZ-104: Microsoft Azure Administrator',
  ...
  { name: 'Bhushanjha Bharat', role: 'Cloud Engineer, India', course: 'AZ-305: Designing Azure Infrastructure Solutions',
  ...
  { name: 'Adham Al Mayasi', role: 'IT Manager, Oman', course: 'SC-300: Microsoft Identity & Access Administrator',
  ...
  { name: 'Emmanuel Masabo', role: 'Network Engineer, Rwanda', course: 'CCNA (200-301): Cisco Certified Network Associate',
  ...
  { name: 'Yoosuf Nizam', role: 'Cloud Architect, Maldives', course: 'AWS Solutions Architect – Associate (SAA-C03)',
  ...
  { name: 'Monica Kalamula', role: 'Systems Administrator, Malawi', course: 'AZ-500: Microsoft Azure Security Technologies',
  ...
  { name: 'David Muriuki', role: 'Security Engineer, Kenya', course: 'CEH v13: Certified Ethical Hacker',
  ...
  { name: 'Fredrick Fiifi Arthur', role: 'Data Analyst, Ghana', course: 'PL-300: Microsoft Power BI Data Analyst',
  ...
  { name: 'Amjaad Kushar', role: 'IT Professional, Saudi Arabia', course: 'SC-200: Microsoft Security Operations Analyst',
...
/* ── Flexi Lead Form Section (matches ILO) ───────────────────── */
const HEAR_OPTIONS = [
...
function FlexiLeadFormSection() {
  const [tab, setTab] = useState<'individual' | 'enterprise'>('individual')
  const [submitted, setSubmitted] = useState(false)
  const [robotChecked, setRobotChecked] = useState(false)
  const [form, setForm] = useState({ fullName: '', email: '', phone: '', courseName: 'Flexi Training', trainees: '', hearAbout: '', message: '' })
      ...
      <div style={{ maxWidth: 700, margin: '0 auto' }}>
        <form onSubmit={e => { e.preventDefault(); setSubmitted(true) }}
          ...
          <div style={{ textAlign: 'center', marginBottom: 24 }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 13, margin: '0 0 16px' }}>Flexi Self-Paced Training with Koenig Solutions</p>
          ...
          {/* Row 1 */}
          <div className="flexi-ilf-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 12 }}>
            <div>
        ...
        <style>{`
          @media(max-width:600px){
            .flexi-ilf-grid { grid-template-columns: 1fr !important; }
            .flexi-ilf-form { padding: 20px 16px !important; }
          }
        `}</style>
      </div>
    </section>
