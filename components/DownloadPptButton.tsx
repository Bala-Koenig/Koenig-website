...
export default function DownloadPptButton() {
  return (
    <a
      ...
      className="group relative flex items-center justify-center gap-2 w-full border border-white/30 text-white/80 hover:border-[#0694D1] hover:text-[#38bdf8] font-semibold px-6 py-3 rounded-xl transition-all duration-300 mt-3 mb-0 overflow-hidden"
    >
